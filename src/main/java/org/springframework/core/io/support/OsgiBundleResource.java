 ...
 * {@link ResourceUtils#CLASSPATH_URL_PREFIX} is
 ...
 * {@link PathMatchingResourcePatternResolver} to retrieve all entries.
 *
 * @author Costin Leau
...
public class OsgiBundleResource extends AbstractResource implements ContextResource {
	 ...
	 * the entire set, consider using {@link PathMatchingResourcePatternResolver}.
	 *
